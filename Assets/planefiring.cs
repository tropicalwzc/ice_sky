...
public class planefiring : MonoBehaviour {
	...
	void OnGUI()
	{
        ...
        switch (weaponlevel)
         ...
         if((Input.GetMouseButton(1)&& sander>10&&(damage_mission_number>0||light_mode==1))&&weaponlevel!=-1)
         {
         ...
         if ((Input.GetMouseButton(2) && sander>10&&flee_mission_number>0&&light_mode==0)&&weaponlevel!=-1)
         {
            flee_mission_number--;
            sander = 0;
