...
public class level5 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            case 0:
                if (timeslope > 30 && current_enemy_total == 0)
                {
                    timeslope = 0;
            ...
            case 3:
                ...
                if (current_enemy_total < 15 && timeslope > 50)
                {
                    timeslope = 0;
            ...
            case 5:
                ...
                if (current_enemy_total < 27 && timeslope > 70)
                {
                    timeslope = 0;
    ...
    void OnGUI()
    {
        if (showorder == 0)
        {
            ...
            GUI.Label(new Rect(420f, 250f, 720f, 200f), "Level 5  背叛者");
            GUI.skin.label.fontSize = 25;
            GUI.Label(new Rect(420f, 450f, 720f, 200f), "好像你的部分小蓝飞机叛变了\n貌似还偷偷地把一些脉冲弹偷走了\n并且在tropical fish的帮助下可以完美地针对你了\n反正脉冲弹只会瘫痪武器系统很垃圾,对吧");
        }
